...
public class CydeoStudent_HW {
    ...
    public CydeoStudent_HW(String name, char gender, int age, int batchNumber, int groupNumber, String fieldOfStudy) {
        this.name = name;
        this.gender = gender;
        this.age = age;
