...
public class FrequencyOfElement {
    ...
    public static void main(String[] args) {
        ...
        int [] arr = {1,1,1,1,11,1,2,2,3,3,3,4,4,1,1,1,1};
    ...
    //                           each  -    [1,1,1,2,3,4,5]     1
    public static int frequencyOfElement(int[] array, int element){ // return the frequency of the given element from the given array INT
        int count = 0 ;
        for (int each: array) {
            if (each == element){
                count ++;
...
// / return the frequency of the given element from the given array DOUBLE
    public static double frequencyOfElement(double[] array, double element){ // return the frequncy of the given element from the given array
        double count = 0 ;
    ...
    // / return the frequency of the given element from the given array Char
    public static char frequencyOfElement(char[] array, char element){ // return the frequncy of the given element from the given array
        char count = 0 ;
        for (char each: array) {
            if (each == element){
                count ++;
